...
goog.exportSymbol('proto.Employess', null, global);
/**
 ...
 * @constructor
 */
proto.Employess = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.Employess.repeatedFields_, null);
};
goog.inherits(proto.Employess, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.Employess.displayName = 'proto.Employess';
}
 ...
 * @const
 */
proto.Employess.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.Employess.prototype.toObject = function(opt_includeInstance) {
  return proto.Employess.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.Employess} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Employess.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.Employess}
 */
proto.Employess.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.Employess;
  return proto.Employess.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.Employess} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.Employess}
 */
proto.Employess.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.Employess.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.Employess.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.Employess} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Employess.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.Employess.prototype.getEmployeesList = function() {
 ...
 * @return {!proto.Employess} returns this
*/
proto.Employess.prototype.setEmployeesList = function(value) {
 ...
 * @return {!proto.Employee}
 */
proto.Employess.prototype.addEmployees = function(opt_value, opt_index) {
 ...
 * @return {!proto.Employess} returns this
 */
proto.Employess.prototype.clearEmployeesList = function() {
